  ...
  */
  ...
  if( i0*i1*i2*i3*i4*i5 >= 0 ) { // not excluded
	...
	if( abs(dx) < _sixCut  && abs(dy) < _sixCut ) { // triplet-driplet match
	  ...
	  double resx = 21; // [um] telescope initial resolution
	  double resy = 20; // [um] telescope initial resolution
